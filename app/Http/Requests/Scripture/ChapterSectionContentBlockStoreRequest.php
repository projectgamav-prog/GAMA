...
class ChapterSectionContentBlockStoreRequest extends RegisteredNoteContentBlockStoreRequest
{
    protected function isContextualInsertionAnchor(ContentBlock $contentBlock): bool
    {
        return $this->chapterSectionAdminRouteContext()
            ->isContextualInsertionAnchor($contentBlock);
    }

    private function chapterSectionAdminRouteContext(): ChapterSectionAdminRouteContext
    {
        return new ChapterSectionAdminRouteContext(
            $this->book(),
            $this->bookSection(),
            $this->chapter(),
            $this->chapterSection(),
