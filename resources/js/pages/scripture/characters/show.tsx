        ...
        <ScriptureLayout title={character.name} breadcrumbs={breadcrumbs}>
                ...
                <section className="space-y-3">
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Public overview text attached directly to this
                            character.
                        </p>
                    </div>
            ...
            {content_blocks.length > 0 && (
                <section className="space-y-3">
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Published editorial blocks attached to this
                            character.
                        </p>
                    </div>
            ...
            <section className="space-y-3">
                <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Verses associated with this character in the public
                        study data.
                    </p>
                </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription className="leading-7">
                                This character is public, but no verse
