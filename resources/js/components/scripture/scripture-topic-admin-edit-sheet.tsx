...
export type ScriptureTopicAdminEditSession =
    | {
          kind: 'entity_details';
...
type Props = {
    session: ScriptureTopicAdminEditSession | null;
    onOpenChange: (open: boolean) => void;
};

export function ScriptureTopicAdminEditSheet({
    session,
    onOpenChange,
}: Props) {
    const detailsForm = useForm<TopicDetailsDraft>({
        description: '',
    });
    ...
    const syncSession = useEffectEvent(
        (currentSession: ScriptureTopicAdminEditSession | null) => {
                    ...
                    <>
                            ...
                            <div className="rounded-2xl border border-border/70 bg-muted/30 px-4 py-4">
                                ...
                                {session.topicDescription ? (
                                    ...
                                    <p className="mt-2 text-sm text-muted-foreground">
                                        No public topic description is set yet.
                                    </p>
                                )}
                            </div>
                        </SheetHeader>
                        ...
                        <div className="flex-1 space-y-6 overflow-y-auto px-4 py-5">
                            {session.kind === 'entity_details' ? (
                                <div className="space-y-5">
                                    <div className="grid gap-2">
                                        ...
                                        <Textarea
                                            ...
                                            rows={8}
                                            placeholder="Add public editorial copy for this topic."
                                        />
                                        <InputError
                                ...
                                <div className="space-y-5">
                                    <div className="grid gap-2">
                                        <Label htmlFor="topic_block_title">
                                            Title
                                        </Label>
                                        <Input
                                            id="topic_block_title"
                                    ...
                                    <div className="grid gap-2">
                                        <Label htmlFor="topic_block_body">
                                            Body
                                        </Label>
                                        <Textarea
                                            id="topic_block_body"
                                            ...
                                            rows={8}
                                            placeholder="Published topic note copy"
                                        />
                                        <InputError
